...
from app.routers import voice, voice_chat, tts, stt, refiner, caption, poster, proactive
...
app = FastAPI(
    ...
    description="AI microservice cho Voice-to-Product, AI Refiner, Caption Generator, Poster Generator và Proactive AI Assistant",
    version="3.0.0",
    lifespan=lifespan,
)
