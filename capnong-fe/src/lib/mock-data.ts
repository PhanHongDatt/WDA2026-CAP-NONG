...
export const MOCK_SEASONAL_PRODUCTS: Product[] = [
  {
    ...
    shop: {
      ...
      province: "Lâm Đồng", district: "Đà Lạt", avatar_url: IMG.farm_dalat,
  ...
  },
  {
    ...
    shop: {
      ...
      province: "Bến Tre", district: "TP. Bến Tre", avatar_url: IMG.farm_bentre,
  ...
  },
  {
    ...
    shop: {
      ...
      province: "Bến Tre", district: "Châu Thành", avatar_url: IMG.farm_bentre,
      owner: FARMER_CHUTU, average_rating: 4.9, total_reviews: 85,
    },
...
export const MOCK_NEW_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    shop: {
      id: "shop-0001", slug: "nong-trai-xanh-da-lat", name: "Nông trại Xanh Đà Lạt",
      province: "Lâm Đồng", district: "Đức Trọng", avatar_url: IMG.farm_dalat,
      owner: FARMER_BACBA, average_rating: 4.8, total_reviews: 120,
    },
...
export const MOCK_SHOPS: Shop[] = [
  ...
  },
  {
    ...
    province: "Đắk Lắk", district: "Krông Năng",
  ...
  },
  {
    ...
    province: "Nghệ An", district: "Quỳ Hợp",
...
export const MOCK_FLASH_DEALS: Product[] = [
  {
    ...
    shop: {
      ...
      province: "Hà Giang", district: "Bắc Quang", avatar_url: IMG.farm_dalat,
      owner: FARMER_BACBA, average_rating: 4.8, total_reviews: 120,
    },
  ...
  },
  {
    ...
    shop: {
      ...
      province: "Cần Thơ", district: "Phong Điền", avatar_url: IMG.farm_cantho,
  ...
  },
  {
    ...
    shop: {
      id: "shop-0001", slug: "nong-trai-xanh-da-lat", name: "Nông trại Xanh",
      province: "Tây Ninh", district: "Tân Biên", avatar_url: IMG.farm_dalat,
      owner: FARMER_BACBA, average_rating: 4.8, total_reviews: 120,
    },
    created_at: "2026-03-15T00:00:00Z", updated_at: "2026-03-15T00:00:00Z",
  },
