...
public interface ProductMapper {
    ...
    @Mapping(target = "shopProvince", source = "shop.province")
    @Mapping(target = "shopWard", source = "shop.ward")
    @Mapping(target = "shopAvatarUrl", source = "shop.avatarUrl")
    @Mapping(target = "shopAverageRating", source = "shop.averageRating")
    @Mapping(target = "shopTotalReviews", source = "shop.totalReviews")
